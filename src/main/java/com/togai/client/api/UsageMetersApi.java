...
public class UsageMetersApi {
     ...
     */
    public okhttp3.Call getUsageMeterCall(String usageMeterId, Boolean includeSchema, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (includeSchema != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("includeSchema", includeSchema));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getUsageMeterValidateBeforeCall(String usageMeterId, Boolean includeSchema, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'usageMeterId' is set
        if (usageMeterId == null) {
            throw new ApiException("Missing the required parameter 'usageMeterId' when calling getUsageMeter(Async)");
        }

        return getUsageMeterCall(usageMeterId, includeSchema, _callback);
     ...
     */
    public UsageMeter getUsageMeter(String usageMeterId, Boolean includeSchema) throws ApiException {
        ApiResponse<UsageMeter> localVarResp = getUsageMeterWithHttpInfo(usageMeterId, includeSchema);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UsageMeter> getUsageMeterWithHttpInfo(String usageMeterId, Boolean includeSchema) throws ApiException {
        okhttp3.Call localVarCall = getUsageMeterValidateBeforeCall(usageMeterId, includeSchema, null);
        Type localVarReturnType = new TypeToken<UsageMeter>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getUsageMeterAsync(String usageMeterId, Boolean includeSchema, final ApiCallback<UsageMeter> _callback) throws ApiException {

        okhttp3.Call localVarCall = getUsageMeterValidateBeforeCall(usageMeterId, includeSchema, _callback);
        Type localVarReturnType = new TypeToken<UsageMeter>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
