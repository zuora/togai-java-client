...
public class PricingSchedulePaginatedResponse implements Serializable {
  ...
  public PricingSchedulePaginatedResponse data(@javax.annotation.Nullable List<PricingScheduleWithPricePlanId> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable List<PricingScheduleWithPricePlanId> data) {
    this.data = data;
  }


  public PricingSchedulePaginatedResponse nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  public PricingSchedulePaginatedResponse previousToken(@javax.annotation.Nullable String previousToken) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PricingSchedulePaginatedResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PricingSchedulePaginatedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PricingSchedulePaginatedResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PricingSchedulePaginatedResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            PricingScheduleWithPricePlanId.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
