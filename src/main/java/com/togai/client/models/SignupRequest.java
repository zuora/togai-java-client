...
public class SignupRequest implements Serializable {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SignupRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SignupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SignupRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
