...
public class GetProposalResponse implements Serializable {
  ...
  public static final String SERIALIZED_NAME_PROPOSAL_RESPONSE_DATE = "proposalResponseDate";
  @SerializedName(SERIALIZED_NAME_PROPOSAL_RESPONSE_DATE)
  @javax.annotation.Nullable
  private OffsetDateTime proposalResponseDate;

  public GetProposalResponse() {
  }

  public GetProposalResponse id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public GetProposalResponse accountId(@javax.annotation.Nonnull String accountId) {
  ...
  public GetProposalResponse pricePlanId(@javax.annotation.Nullable String pricePlanId) {
  ...
  public GetProposalResponse quantity(@javax.annotation.Nullable Integer quantity) {
  ...
  public GetProposalResponse rateCardQuantities(@javax.annotation.Nullable Map<String, BigDecimal> rateCardQuantities) {
    this.rateCardQuantities = rateCardQuantities;
    return this;
  }

  public GetProposalResponse putRateCardQuantitiesItem(String key, BigDecimal rateCardQuantitiesItem) {
  ...
  public GetProposalResponse idempotencyKey(@javax.annotation.Nullable String idempotencyKey) {
  ...
  public GetProposalResponse pricePlanVersion(@javax.annotation.Nullable Integer pricePlanVersion) {
  ...
  public GetProposalResponse purchasePlanOverride(@javax.annotation.Nullable PricePlanDetailsOverride purchasePlanOverride) {
  ...
  public GetProposalResponse associationOverride(@javax.annotation.Nullable CreatePricePlanDetailsOverride associationOverride) {
  ...
  public GetProposalResponse walletTopupDetails(@javax.annotation.Nullable WalletTopupDetails walletTopupDetails) {
  ...
  public GetProposalResponse createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public GetProposalResponse updatedAt(@javax.annotation.Nullable OffsetDateTime updatedAt) {
  ...
  public GetProposalResponse effectiveFrom(@javax.annotation.Nullable LocalDate effectiveFrom) {
  ...
  public GetProposalResponse effectiveUntil(@javax.annotation.Nullable LocalDate effectiveUntil) {
  ...
  public GetProposalResponse expiryDate(@javax.annotation.Nullable OffsetDateTime expiryDate) {
  ...
  public GetProposalResponse price(@javax.annotation.Nullable BigDecimal price) {
    this.price = price;
    return this;
  }
  ...
  public GetProposalResponse invoiceId(@javax.annotation.Nullable String invoiceId) {
  ...
  public GetProposalResponse invoiceCurrency(@javax.annotation.Nullable String invoiceCurrency) {
  ...
  public GetProposalResponse status(@javax.annotation.Nonnull PurchaseStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetProposalResponse type(@javax.annotation.Nonnull PurchaseType type) {
    this.type = type;
    return this;
  }
  ...
  public GetProposalResponse comment(@javax.annotation.Nullable String comment) {
  ...
  public GetProposalResponse paymentMode(@javax.annotation.Nonnull PaymentModeEnum paymentMode) {
  ...
  public GetProposalResponse proposalResponseDate(@javax.annotation.Nullable OffsetDateTime proposalResponseDate) {
    this.proposalResponseDate = proposalResponseDate;
    return this;
  }

  /**
   * Get proposalResponseDate
   * @return proposalResponseDate
   */
  @javax.annotation.Nullable
  public OffsetDateTime getProposalResponseDate() {
    return proposalResponseDate;
  }

  public void setProposalResponseDate(@javax.annotation.Nullable OffsetDateTime proposalResponseDate) {
    this.proposalResponseDate = proposalResponseDate;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetProposalResponse getProposalResponse = (GetProposalResponse) o;
    return Objects.equals(this.id, getProposalResponse.id) &&
        Objects.equals(this.accountId, getProposalResponse.accountId) &&
        Objects.equals(this.pricePlanId, getProposalResponse.pricePlanId) &&
        Objects.equals(this.quantity, getProposalResponse.quantity) &&
        Objects.equals(this.rateCardQuantities, getProposalResponse.rateCardQuantities) &&
        Objects.equals(this.idempotencyKey, getProposalResponse.idempotencyKey) &&
        Objects.equals(this.pricePlanVersion, getProposalResponse.pricePlanVersion) &&
        Objects.equals(this.purchasePlanOverride, getProposalResponse.purchasePlanOverride) &&
        Objects.equals(this.associationOverride, getProposalResponse.associationOverride) &&
        Objects.equals(this.walletTopupDetails, getProposalResponse.walletTopupDetails) &&
        Objects.equals(this.createdAt, getProposalResponse.createdAt) &&
        Objects.equals(this.updatedAt, getProposalResponse.updatedAt) &&
        Objects.equals(this.effectiveFrom, getProposalResponse.effectiveFrom) &&
        Objects.equals(this.effectiveUntil, getProposalResponse.effectiveUntil) &&
        Objects.equals(this.expiryDate, getProposalResponse.expiryDate) &&
        Objects.equals(this.price, getProposalResponse.price) &&
        Objects.equals(this.invoiceId, getProposalResponse.invoiceId) &&
        Objects.equals(this.invoiceCurrency, getProposalResponse.invoiceCurrency) &&
        Objects.equals(this.status, getProposalResponse.status) &&
        Objects.equals(this.type, getProposalResponse.type) &&
        Objects.equals(this.comment, getProposalResponse.comment) &&
        Objects.equals(this.paymentMode, getProposalResponse.paymentMode) &&
        Objects.equals(this.proposalResponseDate, getProposalResponse.proposalResponseDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, accountId, pricePlanId, quantity, rateCardQuantities, idempotencyKey, pricePlanVersion, purchasePlanOverride, associationOverride, walletTopupDetails, createdAt, updatedAt, effectiveFrom, effectiveUntil, expiryDate, price, invoiceId, invoiceCurrency, status, type, comment, paymentMode, proposalResponseDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetProposalResponse {\n");
    ...
    sb.append("    proposalResponseDate: ").append(toIndentedString(proposalResponseDate)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("proposalResponseDate");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetProposalResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProposalResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetProposalResponse is not found in the empty JSON string", GetProposalResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProposalResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProposalResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetProposalResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetProposalResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetProposalResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetProposalResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetProposalResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetProposalResponse>() {
           @Override
           public void write(JsonWriter out, GetProposalResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetProposalResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetProposalResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetProposalResponse
   * @throws IOException if the JSON string is invalid with respect to GetProposalResponse
   */
  public static GetProposalResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetProposalResponse.class);
  }

  /**
   * Convert an instance of GetProposalResponse to an JSON string
   *
   * @return JSON string
   */
