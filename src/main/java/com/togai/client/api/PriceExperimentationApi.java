...
import com.togai.client.models.CalculateRevenueResponseV2;
...
public class PriceExperimentationApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PriceExperimentationApi() {
        this(Configuration.getDefaultApiClient());
    }

    public PriceExperimentationApi(ApiClient apiClient) {
    ...
    /**
     * (DEPRECATED) Calculate and return the revenue for a existing or new price plan (asynchronously)
     * Calculate and return the revenue for a existing or new price plan
     * @param calculateRevenueRequest Request payload for calculateRevenueAPI (required)
    ...
    /**
     * Build call for calculateRevenueV2
     * @param calculateRevenueRequest Request payload for calculateRevenueAPI (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call calculateRevenueV2Call(CalculateRevenueRequest calculateRevenueRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/v2/revenue_calculator";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call calculateRevenueV2ValidateBeforeCall(CalculateRevenueRequest calculateRevenueRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'calculateRevenueRequest' is set
        if (calculateRevenueRequest == null) {
            throw new ApiException("Missing the required parameter 'calculateRevenueRequest' when calling calculateRevenueV2(Async)");
        }

        return calculateRevenueV2Call(calculateRevenueRequest, _callback);
     ...
     */
    public CalculateRevenueResponseV2 calculateRevenueV2(CalculateRevenueRequest calculateRevenueRequest) throws ApiException {
        ApiResponse<CalculateRevenueResponseV2> localVarResp = calculateRevenueV2WithHttpInfo(calculateRevenueRequest);
        return localVarResp.getData();
    }
     ...
     * Calculate and return the revenue for a existing or new price plan v2
     * @param calculateRevenueRequest Request payload for calculateRevenueAPI (required)
     * @return ApiResponse&lt;CalculateRevenueResponseV2&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<CalculateRevenueResponseV2> calculateRevenueV2WithHttpInfo(CalculateRevenueRequest calculateRevenueRequest) throws ApiException {
        okhttp3.Call localVarCall = calculateRevenueV2ValidateBeforeCall(calculateRevenueRequest, null);
        Type localVarReturnType = new TypeToken<CalculateRevenueResponseV2>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Calculate and return the revenue for a existing or new price plan v2 (asynchronously)
     * Calculate and return the revenue for a existing or new price plan v2
     * @param calculateRevenueRequest Request payload for calculateRevenueAPI (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call calculateRevenueV2Async(CalculateRevenueRequest calculateRevenueRequest, final ApiCallback<CalculateRevenueResponseV2> _callback) throws ApiException {

        okhttp3.Call localVarCall = calculateRevenueV2ValidateBeforeCall(calculateRevenueRequest, _callback);
        Type localVarReturnType = new TypeToken<CalculateRevenueResponseV2>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
