...
public class ListCreditsResponse implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    ListCreditsResponse listCreditsResponse = (ListCreditsResponse) o;
    return Objects.equals(this.data, listCreditsResponse.data) &&
        Objects.equals(this.nextToken, listCreditsResponse.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListCreditsResponse {\n");
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListCreditsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListCreditsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListCreditsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListCreditsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListCreditsResponse>() {
           @Override
           public void write(JsonWriter out, ListCreditsResponse value) throws IOException {
