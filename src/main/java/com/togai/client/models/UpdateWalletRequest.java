...
public class UpdateWalletRequest implements Serializable {
  ...
  public UpdateWalletRequest effectiveFrom(@javax.annotation.Nullable OffsetDateTime effectiveFrom) {
  ...
  public UpdateWalletRequest status(@javax.annotation.Nullable WalletStatus status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(@javax.annotation.Nullable WalletStatus status) {
    this.status = status;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.effectiveFrom, updateWalletRequest.effectiveFrom) &&
        Objects.equals(this.status, updateWalletRequest.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(effectiveFrom, status);
  }
