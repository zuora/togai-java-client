...
public class CreatePricePlanMigrationRequest implements Serializable {
  ...
  public static final String SERIALIZED_NAME_REQUIRE_CONFIRMATION = "requireConfirmation";
  @SerializedName(SERIALIZED_NAME_REQUIRE_CONFIRMATION)
  @javax.annotation.Nullable
  private Boolean requireConfirmation;

  public CreatePricePlanMigrationRequest() {
  }

  public CreatePricePlanMigrationRequest sourceId(@javax.annotation.Nonnull String sourceId) {
  ...
  public CreatePricePlanMigrationRequest sourceVersion(@javax.annotation.Nonnull Integer sourceVersion) {
  ...
  public CreatePricePlanMigrationRequest targetId(@javax.annotation.Nullable String targetId) {
  ...
  public CreatePricePlanMigrationRequest targetVersion(@javax.annotation.Nullable Integer targetVersion) {
  ...
  public CreatePricePlanMigrationRequest migrationMode(@javax.annotation.Nonnull MigrationModeEnum migrationMode) {
  ...
  public CreatePricePlanMigrationRequest retainStartOffsets(@javax.annotation.Nullable Boolean retainStartOffsets) {
  ...
  public CreatePricePlanMigrationRequest isPricePlanV2Migration(@javax.annotation.Nullable Boolean isPricePlanV2Migration) {
  ...
  public CreatePricePlanMigrationRequest requireConfirmation(@javax.annotation.Nullable Boolean requireConfirmation) {
  ...
  public void setRequireConfirmation(@javax.annotation.Nullable Boolean requireConfirmation) {
    this.requireConfirmation = requireConfirmation;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreatePricePlanMigrationRequest createPricePlanMigrationRequest = (CreatePricePlanMigrationRequest) o;
    return Objects.equals(this.sourceId, createPricePlanMigrationRequest.sourceId) &&
        Objects.equals(this.sourceVersion, createPricePlanMigrationRequest.sourceVersion) &&
        Objects.equals(this.targetId, createPricePlanMigrationRequest.targetId) &&
        Objects.equals(this.targetVersion, createPricePlanMigrationRequest.targetVersion) &&
        Objects.equals(this.migrationMode, createPricePlanMigrationRequest.migrationMode) &&
        Objects.equals(this.retainStartOffsets, createPricePlanMigrationRequest.retainStartOffsets) &&
        Objects.equals(this.isPricePlanV2Migration, createPricePlanMigrationRequest.isPricePlanV2Migration) &&
        Objects.equals(this.requireConfirmation, createPricePlanMigrationRequest.requireConfirmation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceId, sourceVersion, targetId, targetVersion, migrationMode, retainStartOffsets, isPricePlanV2Migration, requireConfirmation);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreatePricePlanMigrationRequest {\n");
  ...
  static {
    ...
    openapiFields.add("requireConfirmation");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreatePricePlanMigrationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePricePlanMigrationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreatePricePlanMigrationRequest is not found in the empty JSON string", CreatePricePlanMigrationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePricePlanMigrationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreatePricePlanMigrationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreatePricePlanMigrationRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreatePricePlanMigrationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreatePricePlanMigrationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreatePricePlanMigrationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreatePricePlanMigrationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreatePricePlanMigrationRequest>() {
           @Override
           public void write(JsonWriter out, CreatePricePlanMigrationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreatePricePlanMigrationRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreatePricePlanMigrationRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreatePricePlanMigrationRequest
   * @throws IOException if the JSON string is invalid with respect to CreatePricePlanMigrationRequest
   */
  public static CreatePricePlanMigrationRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreatePricePlanMigrationRequest.class);
  }

  /**
   * Convert an instance of CreatePricePlanMigrationRequest to an JSON string
   *
   * @return JSON string
   */
