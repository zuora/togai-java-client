...
public class EventSchemaListPaginatedResponse implements Serializable {
  ...
  public EventSchemaListPaginatedResponse data(List<EventSchemaListData> data) {
  ...
  **/
  ...
  public void setData(List<EventSchemaListData> data) {
    this.data = data;
  }


  public EventSchemaListPaginatedResponse nextToken(String nextToken) {
  ...
  **/
  ...
  public EventSchemaListPaginatedResponse context(PaginationOptions context) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to EventSchemaListPaginatedResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EventSchemaListPaginatedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!EventSchemaListPaginatedResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventSchemaListPaginatedResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            EventSchemaListData.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
          };
        }
      }
