...
public class EventWithStatus implements Serializable {
  ...
  public EventWithStatus referenceId(@javax.annotation.Nonnull String referenceId) {
  ...
  public EventWithStatus eventPayload(@javax.annotation.Nonnull Event eventPayload) {
  ...
  public EventWithStatus ingestionStatus(@javax.annotation.Nonnull IngestionStatus ingestionStatus) {
  ...
  public EventWithStatus customerId(@javax.annotation.Nullable String customerId) {
  ...
  public EventWithStatus source(@javax.annotation.Nullable EventSource source) {
    this.source = source;
    return this;
  }
  ...
  public EventWithStatus createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.referenceId, eventWithStatus.referenceId) &&
        Objects.equals(this.eventPayload, eventWithStatus.eventPayload) &&
        ...
        Objects.equals(this.source, eventWithStatus.source) &&
        Objects.equals(this.createdAt, eventWithStatus.createdAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(referenceId, eventPayload, ingestionStatus, customerId, source, createdAt);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventWithStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventWithStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventWithStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EventWithStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
