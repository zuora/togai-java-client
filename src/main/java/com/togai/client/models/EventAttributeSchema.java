  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventAttributeSchema.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventAttributeSchema' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventAttributeSchema> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventAttributeSchema.class));

       return (TypeAdapter<T>) new TypeAdapter<EventAttributeSchema>() {
           @Override
           public void write(JsonWriter out, EventAttributeSchema value) throws IOException {
