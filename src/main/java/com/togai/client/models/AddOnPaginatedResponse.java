...
public class AddOnPaginatedResponse implements Serializable {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AddOnPaginatedResponse addOnPaginatedResponse = (AddOnPaginatedResponse) o;
    return Objects.equals(this.data, addOnPaginatedResponse.data) &&
        Objects.equals(this.nextToken, addOnPaginatedResponse.nextToken) &&
        Objects.equals(this.context, addOnPaginatedResponse.context);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddOnPaginatedResponse {\n");
  ...
  */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddOnPaginatedResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddOnPaginatedResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddOnPaginatedResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddOnPaginatedResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AddOnPaginatedResponse>() {
           @Override
           public void write(JsonWriter out, AddOnPaginatedResponse value) throws IOException {
