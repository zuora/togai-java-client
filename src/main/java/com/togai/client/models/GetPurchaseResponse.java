...
import com.togai.client.models.PurchaseFeatureDetails;
...
public class GetPurchaseResponse implements Serializable {
  ...
  @javax.annotation.Nullable
  private List<PurchaseFeatureDetails> features = new ArrayList<>();

  public GetPurchaseResponse() {
  }

  public GetPurchaseResponse id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public GetPurchaseResponse accountId(@javax.annotation.Nonnull String accountId) {
  ...
  public GetPurchaseResponse pricePlanId(@javax.annotation.Nullable String pricePlanId) {
  ...
  public GetPurchaseResponse quantity(@javax.annotation.Nullable Integer quantity) {
  ...
  public GetPurchaseResponse rateCardQuantities(@javax.annotation.Nullable Map<String, BigDecimal> rateCardQuantities) {
    this.rateCardQuantities = rateCardQuantities;
    return this;
  }

  public GetPurchaseResponse putRateCardQuantitiesItem(String key, BigDecimal rateCardQuantitiesItem) {
  ...
  public GetPurchaseResponse idempotencyKey(@javax.annotation.Nullable String idempotencyKey) {
  ...
  public GetPurchaseResponse pricePlanVersion(@javax.annotation.Nullable Integer pricePlanVersion) {
  ...
  public GetPurchaseResponse purchasePlanOverride(@javax.annotation.Nullable PricePlanDetailsOverride purchasePlanOverride) {
  ...
  public GetPurchaseResponse associationOverride(@javax.annotation.Nullable CreatePricePlanDetailsOverride associationOverride) {
  ...
  public GetPurchaseResponse walletTopupDetails(@javax.annotation.Nullable WalletTopupDetails walletTopupDetails) {
  ...
  public GetPurchaseResponse createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public GetPurchaseResponse updatedAt(@javax.annotation.Nullable OffsetDateTime updatedAt) {
  ...
  public GetPurchaseResponse effectiveFrom(@javax.annotation.Nullable LocalDate effectiveFrom) {
  ...
  public GetPurchaseResponse effectiveUntil(@javax.annotation.Nullable LocalDate effectiveUntil) {
  ...
  public GetPurchaseResponse expiryDate(@javax.annotation.Nullable OffsetDateTime expiryDate) {
  ...
  public GetPurchaseResponse price(@javax.annotation.Nullable BigDecimal price) {
    this.price = price;
    return this;
  }
  ...
  public GetPurchaseResponse invoiceId(@javax.annotation.Nullable String invoiceId) {
  ...
  public GetPurchaseResponse invoiceCurrency(@javax.annotation.Nullable String invoiceCurrency) {
  ...
  public GetPurchaseResponse status(@javax.annotation.Nonnull PurchaseStatus status) {
    this.status = status;
    return this;
  }
  ...
  public GetPurchaseResponse type(@javax.annotation.Nonnull PurchaseType type) {
    this.type = type;
    return this;
  }
  ...
  public GetPurchaseResponse comment(@javax.annotation.Nullable String comment) {
  ...
  public GetPurchaseResponse purchasePlan(@javax.annotation.Nullable PricePlanDetails purchasePlan) {
  ...
  public GetPurchaseResponse features(@javax.annotation.Nullable List<PurchaseFeatureDetails> features) {
    this.features = features;
    return this;
  }

  public GetPurchaseResponse addFeaturesItem(PurchaseFeatureDetails featuresItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<PurchaseFeatureDetails> getFeatures() {
    return features;
  }

  public void setFeatures(@javax.annotation.Nullable List<PurchaseFeatureDetails> features) {
    this.features = features;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetPurchaseResponse getPurchaseResponse = (GetPurchaseResponse) o;
    return Objects.equals(this.id, getPurchaseResponse.id) &&
        Objects.equals(this.accountId, getPurchaseResponse.accountId) &&
        Objects.equals(this.pricePlanId, getPurchaseResponse.pricePlanId) &&
        Objects.equals(this.quantity, getPurchaseResponse.quantity) &&
        Objects.equals(this.rateCardQuantities, getPurchaseResponse.rateCardQuantities) &&
        Objects.equals(this.idempotencyKey, getPurchaseResponse.idempotencyKey) &&
        Objects.equals(this.pricePlanVersion, getPurchaseResponse.pricePlanVersion) &&
        Objects.equals(this.purchasePlanOverride, getPurchaseResponse.purchasePlanOverride) &&
        Objects.equals(this.associationOverride, getPurchaseResponse.associationOverride) &&
        Objects.equals(this.walletTopupDetails, getPurchaseResponse.walletTopupDetails) &&
        Objects.equals(this.createdAt, getPurchaseResponse.createdAt) &&
        Objects.equals(this.updatedAt, getPurchaseResponse.updatedAt) &&
        Objects.equals(this.effectiveFrom, getPurchaseResponse.effectiveFrom) &&
        Objects.equals(this.effectiveUntil, getPurchaseResponse.effectiveUntil) &&
        Objects.equals(this.expiryDate, getPurchaseResponse.expiryDate) &&
        Objects.equals(this.price, getPurchaseResponse.price) &&
        Objects.equals(this.invoiceId, getPurchaseResponse.invoiceId) &&
        Objects.equals(this.invoiceCurrency, getPurchaseResponse.invoiceCurrency) &&
        Objects.equals(this.status, getPurchaseResponse.status) &&
        Objects.equals(this.type, getPurchaseResponse.type) &&
        Objects.equals(this.comment, getPurchaseResponse.comment) &&
        Objects.equals(this.purchasePlan, getPurchaseResponse.purchasePlan) &&
        Objects.equals(this.features, getPurchaseResponse.features);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, accountId, pricePlanId, quantity, rateCardQuantities, idempotencyKey, pricePlanVersion, purchasePlanOverride, associationOverride, walletTopupDetails, createdAt, updatedAt, effectiveFrom, effectiveUntil, expiryDate, price, invoiceId, invoiceCurrency, status, type, comment, purchasePlan, features);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetPurchaseResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetPurchaseResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetPurchaseResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetPurchaseResponse is not found in the empty JSON string", GetPurchaseResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetPurchaseResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetPurchaseResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetPurchaseResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("features") != null && !jsonObj.get("features").isJsonNull()) {
        ...
        if (jsonArrayfeatures != null) {
          ...
          for (int i = 0; i < jsonArrayfeatures.size(); i++) {
            PurchaseFeatureDetails.validateJsonElement(jsonArrayfeatures.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetPurchaseResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetPurchaseResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetPurchaseResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetPurchaseResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetPurchaseResponse>() {
           @Override
           public void write(JsonWriter out, GetPurchaseResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetPurchaseResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetPurchaseResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetPurchaseResponse
   * @throws IOException if the JSON string is invalid with respect to GetPurchaseResponse
   */
  public static GetPurchaseResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetPurchaseResponse.class);
  }

  /**
   * Convert an instance of GetPurchaseResponse to an JSON string
   *
   * @return JSON string
   */
