...
public class PricePlanPaginatedResponse implements Serializable {
  ...
  public PricePlanPaginatedResponse data(@javax.annotation.Nonnull List<PricePlanListData> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull List<PricePlanListData> data) {
    this.data = data;
  }


  public PricePlanPaginatedResponse nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  public PricePlanPaginatedResponse context(@javax.annotation.Nullable PaginationOptions context) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PricePlanPaginatedResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PricePlanPaginatedResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PricePlanPaginatedResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PricePlanPaginatedResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        PricePlanListData.validateJsonElement(jsonArraydata.get(i));
      };
