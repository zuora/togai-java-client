...
public class MiscellaneousCharge implements Serializable {
  ...
  public MiscellaneousCharge name(String name) {
  ...
  **/
  ...
  public MiscellaneousCharge value(String value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to MiscellaneousCharge
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MiscellaneousCharge.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MiscellaneousCharge.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MiscellaneousCharge` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
