...
import com.togai.core.service.client.auth.HttpBasicAuth;
import com.togai.core.service.client.auth.HttpBearerAuth;
import com.togai.core.service.client.auth.ApiKeyAuth;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://sandbox-api.togai.com";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
