...
import com.togai.client.models.CreateCustomerContactRequest;
import com.togai.client.models.CreateCustomerContactResponse;
...
public class CustomersApi {
    ...
    /**
     * Build call for createCustomerContact
     * @param customerId  (required)
     * @param createCustomerContactRequest Payload to create a contact for a customer (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> Response for CreateCustomerContactRequest </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Error response </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Error response </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Error response </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Error response </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call createCustomerContactCall(String customerId, CreateCustomerContactRequest createCustomerContactRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = createCustomerContactRequest;

        // create path and map variables
        String localVarPath = "/customers/{customer_id}/contacts"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createCustomerContactValidateBeforeCall(String customerId, CreateCustomerContactRequest createCustomerContactRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'customerId' is set
        if (customerId == null) {
            throw new ApiException("Missing the required parameter 'customerId' when calling createCustomerContact(Async)");
        }

        // verify the required parameter 'createCustomerContactRequest' is set
        if (createCustomerContactRequest == null) {
            throw new ApiException("Missing the required parameter 'createCustomerContactRequest' when calling createCustomerContact(Async)");
        }

        return createCustomerContactCall(customerId, createCustomerContactRequest, _callback);
     ...
     * @param customerId  (required)
     * @param createCustomerContactRequest Payload to create a contact for a customer (required)
     * @return CreateCustomerContactResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public CreateCustomerContactResponse createCustomerContact(String customerId, CreateCustomerContactRequest createCustomerContactRequest) throws ApiException {
        ApiResponse<CreateCustomerContactResponse> localVarResp = createCustomerContactWithHttpInfo(customerId, createCustomerContactRequest);
        return localVarResp.getData();
    }
     ...
     * @param customerId  (required)
     * @param createCustomerContactRequest Payload to create a contact for a customer (required)
     * @return ApiResponse&lt;CreateCustomerContactResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<CreateCustomerContactResponse> createCustomerContactWithHttpInfo(String customerId, CreateCustomerContactRequest createCustomerContactRequest) throws ApiException {
        okhttp3.Call localVarCall = createCustomerContactValidateBeforeCall(customerId, createCustomerContactRequest, null);
        Type localVarReturnType = new TypeToken<CreateCustomerContactResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Create a contact for the customer (asynchronously)
     * This API let’s you to create a contact for the customer
     * @param customerId  (required)
     * @param createCustomerContactRequest Payload to create a contact for a customer (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call createCustomerContactAsync(String customerId, CreateCustomerContactRequest createCustomerContactRequest, final ApiCallback<CreateCustomerContactResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = createCustomerContactValidateBeforeCall(customerId, createCustomerContactRequest, _callback);
        Type localVarReturnType = new TypeToken<CreateCustomerContactResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
