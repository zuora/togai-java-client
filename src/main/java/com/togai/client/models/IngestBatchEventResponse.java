...
public class IngestBatchEventResponse implements Serializable {
  ...
  * @throws IOException if the JSON Object is invalid with respect to IngestBatchEventResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!IngestBatchEventResponse.openapiFields.contains(entry.getKey())) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IngestBatchEventResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IngestBatchEventResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IngestBatchEventResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IngestBatchEventResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<IngestBatchEventResponse>() {
           @Override
           public void write(JsonWriter out, IngestBatchEventResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public IngestBatchEventResponse read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of IngestBatchEventResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IngestBatchEventResponse
  * @throws IOException if the JSON string is invalid with respect to IngestBatchEventResponse
  */
  public static IngestBatchEventResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IngestBatchEventResponse.class);
  }

 /**
  * Convert an instance of IngestBatchEventResponse to an JSON string
  *
  * @return JSON string
  */
